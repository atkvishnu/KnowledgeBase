...
int main()
{
    ...
    int a;
    fin >> a;
    // stderr and stdout are returned to you when errors occur
    // fout << a+b << endl;		// reported output has `_'s substituted for spaces
    // 
    // https://train.usaco.org/usacoprob2?a=b0UzQpJbBb0&S=friday
    // 
    return 0;
}