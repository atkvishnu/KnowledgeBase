// https://www.codechef.com/MAY221D/problems/SUGARCANE
...
int32_t main()
{
    ...
    testcases {
    	int n;
    	cin >> n;
    	ll total_profit = n * 50;
    	ll sugar_cane = total_profit * 20 / 100;
    	ll salt_mint = total_profit * 20 / 100;
    	ll rent = total_profit * 30 / 100;

    	ll profit = total_profit - sugar_cane - salt_mint - rent;
