/*https://www.codechef.com/APRIL222D/problems/CEFDIV*/
#include <bits/stdc++.h>
...
#define utility_parity(n) __builtin_parityll(n)
inline int utility_last_bit(int n){return n & (-n);}
inline int utility_MSB(int n){return n >> (sizeof(n)*8-1)&1;}
...
int32_t main()
{
    ...
    testcases {
      ...
      // cout << vect << endl;
      // non-empty contiguous subarrays such that each element belongs to one of these subarrays
      // no. of ways to partition vect such that parity of the sum of elems within
      // the subarray is alternating.

    }
    cout << PARITY(3) << " " << PARITY(6) << " " << PARITY(5) << endl;
    cout << PARITY(1) << " " << PARITY(2) << " " << PARITY(3) << " " << PARITY(8) << endl;
