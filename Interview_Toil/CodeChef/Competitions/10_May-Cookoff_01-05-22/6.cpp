// https://www.codechef.com/COOK141D/problems/TRIPLE_INVS
...
/*========================================================================================*/
bool check(string n) {
  if (n == "000"  n == "001"  n == "012"  n == "013"  n == "120"  n == "121"  n == "132"  n == "133"  n == "200"  n == "201"  n == "212"  n == "213"  n == "320"  n == "321"  n == "332" || n == "333" ) {
    return true;
  }
  else return false;
}
...
int32_t main()
{
    ...
    testcases {
    	...
    	// if(sum == 0 || !utility_is_sorted(vect)) {
    	// 	cout << "YES\n";
    	// } else if(utility_is_sorted(vect)) {
    	// 	cout << "NO\n";
    	// } 
