...
int32_t main()
{
    ...
    cout << utility_nCr(0,0) << utility_nCr(1,0) << utility_nCr(1,1) << utility_nCr(2,0) << utility_nCr(2,1) << utility_nCr(2,2) << utility_nCr(3,0) << utility_nCr(3,1) << utility_nCr(3,2) << utility_nCr(3,3) << endl;
