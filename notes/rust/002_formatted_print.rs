...
fn main() {
    ...
    // Without a suffix, 31 becomes an i32. You can change what type 31 is by providing a suffix. The number 31i64 for example has the type i64.
...
/*
 * `std::ftm` contains many `traits` which govern the display of text.
 * The base form of two important anes are listed below:
 * 	
