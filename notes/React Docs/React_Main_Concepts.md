#to-sort 
# React JS docs - MAIN Concepts 
[React JS docs - MAIN Concepts](https://reactjs.org/docs/hello-world.html)

***This markdown file is a copy of React JS docs.***
...
> `NOTE`: Whatever is inside {<---->} curly braces will be treated as a javascript code!
...
class LoggingButton extends React.Component {
  ...
  render() {
    // This syntax ensures `this` is bound within handleClick    return (      <button onClick={() => this.handleClick()}>        
		 Click me
       </button>
    );
  }
...
![Diagram showing nesting of components](https://reactjs.org/static/9381f09e609723a8bb6e4ba1a7713b46/90cbd/thinking-in-react-components.png)
