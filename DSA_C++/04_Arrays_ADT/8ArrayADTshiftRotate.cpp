...
void LeftShift3(struct Array *arr, int n)               //SO-CodeReview
{
    if (n > arr->length) {
        n = arr->length;
    }
    ...
    for (int i=arr->length - n; i < arr->size; i++)
    { 
        arr->A[i] = 0;
    }
}
...
void LeftShift4(struct Array* arr, unsigned int n)      //best      //SO-CodeReview
{
    int i;
    for (i = 0; i < arr->length; i++) {
        if (i + n < arr->length)
...
void LeftShift5(struct Array *arr, int n)            //SO-CodeReview
{
    if (n > arr->length) {
        n = arr->length;
    }
...
// Left Rotate------------------------------------------------------------------------------------------
void LeftRotate2(struct Array *arr, int n)    //n is the number of shifts
{
...
//Right shift optimization-------------------------------------------------------------------------------------------------------
void RightShift2(struct Array *arr, int n)    //n is the number of shifts
{
