...
// Member functions
// append, assign, at, back, begin, capacity, cbegin, cend, clear, compare, copy
// crbegin, crend, c_str, data, empty, end, erase, find, find_first_not_of, find_first_of
// find_last_not_of, find_last_of, front, get_allocator, insert, length
// max_size, += , = , [], pop_back, push_back, rbegin, rend, replace,
// reserve, resize, rfind, shrink_to_fit, size, substr, swap

// Sorting according to categories: 

// Main fns. : (constructor), (destructor), operator =
...
// Element access: operaor [], at, back, front
...
// Member constants: string::npos

// Non-member Overloads: getline, operator +, operator <<, operator >>, relational operators, swap

// One-line definitions of the above mentioned fns, operators, etc.:
// Member functions
